<template>
  <!--
  Elsewhere I've avoided using the Bootstrap Vue components but it seems useful here,
  as they have built-in support for active link highlights based on Vue routes.
  -->
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <input id="navbarNavToggleCBox" type="checkbox">
    <label
      for="navbarNavToggleCBox"
      class="navbar-toggler"
      data-toggle="collapse"
      data-target="#navbarNav"
      aria-controls="navbarNav"
...
<style>
#navbarNavToggleCBox:checked ~ .collapse {
    display:block;
}
